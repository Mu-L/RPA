...
const UIV_METHODS = [
  ...
  { text: 'getVar(', displayText: "getVar('name' | '!CURRENT_TAB_NUMBER'[, default]) - read a Ui.Vision variable, special ones included (!LASTCOMMANDOK, !COL1, !IMAGEX); throws on an unknown name or one that is not set yet. The page URL is eval('return location.href') - !URL is table-macros-only and throws here" },
